...
public class SuffixTreeTest {
	...
	public void generatesSimplestTree() {
		...
		assertThat((Object) edgeA.getItemAt(3),
				is((Object) SequenceTerminal.getInstance()));
		...
		Edge<String> edgeLeaf = tree.getRoot().getEdgeStarting(
	...
	public void simpleSuffixLinking() {
		...
		Edge<String> edgeLeaf = root.getEdgeStarting(SequenceTerminal
				.getInstance());
		assertThat(edgeLeaf.getLength(), is(1));
		assertThat(edgeLeaf.isTerminating(), is(false));
	}
	...
	public void followSuffixLinks() {
		...
		// all edges from root->$
		Edge<String> edge_leaf = root.getEdgeStarting(SequenceTerminal
				.getInstance());
		assertThat(edge_leaf.getLength(), is(1));
		assertThat(edge_leaf.isTerminating(), is(false));

		// suffix links
		Node<String> linkA_to_A = root.getEdgeStarting("a").getTerminal()
		...
		Node<String> linkB_to_B = root.getEdgeStarting("a").getTerminal()
				.getEdgeStarting("b").getTerminal().getSuffixLink();
		assertThat(linkB_to_B, is(root.getEdgeStarting("b").getTerminal()));

		Node<String> linkA_to_A2 = root.getEdgeStarting("b").getTerminal()
	...
	public void mississippi() {
		...
		Edge<String> leaf = root
				.getEdgeStarting(SequenceTerminal.getInstance());
	...
	public void followSuffixLinkWhereLengthIsWrong() {
		...
		Edge<String> root_leaf = root.getEdgeStarting(SequenceTerminal
				.getInstance());
