...
class Node<T> implements Iterable<Edge<T>>{
	...
	/**
	 * Inserts the given edge as a child of this node. The edge must not already exist as child or an 
	 * IllegalArgumentException will be thrown.
	 * @param edge The edge to be inserted.
	 * @throws IllegalArgumentException This is thrown when the edge already exists as an out bound edge of this node.
	 */
	...
	/**
	 * @return An iterator which iterates over the child edges. No order is guaranteed.
	 */
	...
	/**
	 * 
	 * @return The node that this nodes suffix link points to if it has one. Null if not.
	 */
