...
public class SuffixTree<T> {
	 ...
	 * @throws Exception
	 */
	SuffixTree(T[] sequenceArray) {
		sequence = new Sequence<T>(sequenceArray);
		// this.sequence = Utils.addTerminalToSequence(sequence,
	 ...
	 * 
	 * @param node
	 *            The node to which the last node inserteds suffix link should
	 *            point to.
	 */
